...
namespace CSharpExercises
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Assert("IsInLeapYear(DateTime.Parse(\"01/01/2000\")) should return true", Exercises.IsLeapYear(DateTime.Parse("01/01/2000")) == true);
            Assert("IsInLeapYear(DateTime.Parse(\"01/01/1904\")) should return true", Exercises.IsLeapYear(DateTime.Parse("01/01/1904")) == true);
            Assert("IsInLeapYear(DateTime.Parse(\"01/01/1900\")) should return false", Exercises.IsLeapYear(DateTime.Parse("01/01/1900")) == false);
            Assert("IsInLeapYear(DateTime.Parse(\"01/01/1901\")) should return false", Exercises.IsLeapYear(DateTime.Parse("01/01/1901")) == false);
            Assert("MortgageCalculator(300000, 3.8M, 30, 1) should return 1397.87", Exercises.MortgageCalculator(300000, 3.8M, 30, 1) == 1397.87M);            //Assert("DuckGoose(100) should print correctly", Exercises.DuckGoose(100) == Constants.DuckGooseResult);
